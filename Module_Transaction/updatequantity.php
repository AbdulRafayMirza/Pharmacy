...
<head>
    ...
    <meta charset="utf-8">
    <title>Pharmacy - Update Quantity</title>
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Update Quantity</li>
                                </ol>
                                <!--end breadcrumb-->
                            </div>
                            <!--end /div-->
                            <h4 class="page-title">Update Quantity</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                    ...
                                    <div class="col-sm-12">
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-sm-1 col-form-label">Expiry Date</label>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-sm-1 col-form-label">Old Quantity</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" type="text" id="oldquantity" disabled>
                                                </div>

                                                <label class="col-sm-1 col-form-label">New Quantity</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" type="text" id="newquantity">
                                                </div>
