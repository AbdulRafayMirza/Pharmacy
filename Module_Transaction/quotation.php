                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <!--end /div-->
                            <h4 class="page-title">Sale Quotation</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5"><select class="form-control" type="text"
                                                    id="itemname">
                                                    <option>Acylex 200mg</option>
                                                </select>
                                            </div>

                                            <label class="col-sm-2 col-form-label text-right">Item ID</label>
                                            <div class="col-sm-3">
                                                <input class="form-control" type="text" id="itemid" value="1" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="border: 3px solid #1c1c1c; height: 180px;">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7"><input class="form-control" type="text" id="discount"
                                                    value="0"></div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7"><input class="form-control" type="text" id="bonus"
                                                    value="0"></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4><u>Amount</u></h4>
                                <div class="row mt-3">
                                    <div class="col-md-6 pt-3" style="border: 3px solid #1c1c1c;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="checkbox" id="discount_"> Discount %</label>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label text-right">
                                            <input type="checkbox" id="totalwithdiscount_">Total With Discount %</label>
                                            <div class="col-sm-8"><input class="form-control" type="text" id="p_discount"
                                                    value="0" readonly disabled>
                                            </div>
                                        </div>
