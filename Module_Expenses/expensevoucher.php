                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <!--end /div-->
                            <h4 class="page-title">Expense Voucher</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <fieldset class="form-group border p-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label text-right">Voucher No</label>
                                                        <div class="col-sm-8"><input class="form-control" type="text"
                                                                id="voucherno" value="1" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            <div class="row">    
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label text-right">Voucher Date</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8"><select class="form-control" id="vouchar_currency">
                                                                <option>PKR</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label text-right">Expense Type</label>
                                                        <div class="col-sm-8"><input class="form-control" type="text"
                                                                id="voucher_expensetype"></div>
                                                    </div>
                                                </div>

                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label text-right">Employees</label>
                                                        <div class="col-sm-8"><input class="form-control" type="text" disabled
                                                                id="voucher_employees"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label text-right">Payment Made</label>
                                                        <div class="col-sm-8"><select class="form-control" id="vouchar_paymentmade">
                                                                <option>PKR</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label text-right">Account</label>
                                                        <div class="col-sm-8"><input class="form-control" type="text"
                                                                id="voucher_account"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label text-right">Naration</label>
                                                        <div class="col-sm-10"><input class="form-control" type="text"
                                                                id="vouchar_naration"></div>
                                                    </div>
                                                </div>                                          
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-5">
                                        <fieldset class="form-group border p-3">
                                                <legend class="w-auto px-2">Bank Information</legend>
                                                        
                                                <div class="col-lg-12">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label text-right">Bank Name</label>
                                                        <div class="col-sm-8"><input class="form-control" type="text" disabled
                                                                id="voucher_bankname"></div>
                                                    </div>
                                                </div>  

                                                <div class="col-lg-12">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label text-right">Account No</label>
                                                        <div class="col-sm-8"><input class="form-control" type="text" disabled
                                                                id="voucher_accountno"></div>
                                                    </div>
                                                </div> 
