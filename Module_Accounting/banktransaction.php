...
<head>
    ...
    <meta charset="utf-8">
    <title>Pharmacy - Bank Transaction</title>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <!--end /div-->
                            <h4 class="page-title">Bank Transaction</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><input class="form-control" type="text"
                                                    id="bank_transactionNo" value="1" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><input class="form-control" type="date"
                                                    id="bank_transactiondate"></div>
                                        </div>
                                    </div>

                                    <div class="col-lg-12">
                                        <div class="form-group row">
                                            <label class="col-sm-1 col-form-label text-right">Bank</label>
                                            <div class="col-sm-11"><select class="form-control" id="bank">
                                                    <option></option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><select class="form-control" id="bank_transtype">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><select class="form-control" id="bank_currency">
                                                    <option>PKR</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><select class="form-control" id="bank_customer"
                                                    disabled>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><select class="form-control" id="bank_vendor"
                                                    disabled>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11"><input class="form-control" type="text"
                                                    id="bank_narration"></div>
                                        </div>
                                    </div>
                                </div>
