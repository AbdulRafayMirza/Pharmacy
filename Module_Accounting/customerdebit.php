...
<head>
    ...
    <meta charset="utf-8">
    <title>Pharmacy - Customer Debit</title>
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Customer Debit</li>
                                </ol>
                                <!--end breadcrumb-->
                            </div>
                            <!--end /div-->
                            <h4 class="page-title">Customer Debit</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><input class="form-control" type="date" id="debit_transactiondate"></div>
                                        </div>                        
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><select class="form-control" id="debit_currency">
                                                    <option>PKR</option>
                                                </select>
                                            </div>
                                        </div>                                        
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11"><input class="form-control" type="text" id="debit_remarks"></div>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><select class="form-control" id="debit_customer">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><input class="form-control" type="text" id="debit_account"></div>
                                        </div>                                        
                                    </div>
                                </div>
