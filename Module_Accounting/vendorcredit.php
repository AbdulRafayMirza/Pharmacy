...
<head>
    ...
    <meta charset="utf-8">
    <title>Pharmacy - Vendor Credit</title>
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Vendor Credit</li>
                                </ol>
                                <!--end breadcrumb-->
                            </div>
                            <!--end /div-->
                            <h4 class="page-title">Vendor Credit</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10"><select class="form-control" id="credit_vendor">
