                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row"><label for="textarea-input-address" class="col-sm-2 col-form-label text-right">Address</label>
                                            ...
                                            <div class="col-sm-3"><input class="btn btn-info" type="button" id="text-input-customer-reg-date" value="Excel"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row"><label for="text-input-customer-email" class="col-sm-2 col-form-label text-right">Email</label>
                                            <div class="col-sm-10"><input class="form-control" type="email" id="text-input-customer-email"></div>
                                        </div>
                                        ...
                                        <div class="form-group row"><label for="text-input-customer-reg-date" class="col-sm-2 col-form-label text-right">Reg. Date</label>
                                            <div class="col-sm-7"><input class="form-control" type="date" id="text-input-customer-reg-date"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 155.889px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Customer Name</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 240.889px;" aria-label="Position: activate to sort column ascending">Category</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 113.889px;" aria-label="Office: activate to sort column ascending">Customer Type</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 51.8889px;" aria-label="Age: activate to sort column ascending">Phone</th>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 51.8889px;" aria-label="Age: activate to sort column ascending">Class</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 51.8889px;" aria-label="Age: activate to sort column ascending">Remarks</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 51.8889px;" aria-label="Age: activate to sort column ascending">Reg Date</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
