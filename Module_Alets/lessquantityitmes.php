...
<head>
    ...
    <meta charset="utf-8">
    <title>Pharmacy - Less Quantity Items</title>    
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Less Quantity Items</li>
                                </ol>
                                <!--end breadcrumb-->
                            </div>
                            <!--end /div-->
                            <h4 class="page-title">Less Quantity Items</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <h2><b>List Of Less Quantity Stock Items</b></h2>
                                        </div>                        
                                    </div>
