...
<head>
    ...
    <meta charset="utf-8">
    <title>Pharmacy - Not Sold Items</title>    
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Not Sold Items</li>
                                </ol>
                                <!--end breadcrumb-->
                            </div>
                            <!--end /div-->
                            <h4 class="page-title">Not Sold Items</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <h2><b>List Of Not Sold Items</b></h2>
                                        </div>                        
                                    </div>
                                        ...
                                        <table id="mytable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style="width: 51.8889px;">Padding Type</th>
